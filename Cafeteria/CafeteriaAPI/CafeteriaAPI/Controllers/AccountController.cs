...
using CafeteriaAPI.Providers;
using CafeteriaAPI.Results;
...
namespace CafeteriaAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.UserName, Name = model.Name, PhoneNumber = model.Phone, ImageUrl = "default.png", Email = model.Email };

            if (model.ImageBase != null)
            {
                user.ImageUrl = saveImage(model.ImageBase);
            }
